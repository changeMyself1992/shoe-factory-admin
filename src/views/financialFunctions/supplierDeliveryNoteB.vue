    ...
    <el-card v-if="管理权限['供应商流水单列表可读']" class="bx-card">
      <div slot="header" class="clearfix">
        <delivery-note-condition-query
          ...
          :unique-id="unique_id"
          :specified-time-period="specifiedTimePeriod"
          :radio="radio"
        />
      </div>
    </el-card>

    <el-card class="bx-card">
      <div slot="header" class="clearfix" style="text-align: center;">
        <strong>{{ name }} 流水单记录</strong>
      </div>
      <div class="module-c">
        <div class="row-1">
          <div class="btn">
        ...
        >
          ...
          <el-table-column align="center" prop="供应商名称" label="供应商名称" min-width="200">
            <template slot-scope="scope">
...
export default {
  ...
  created() {
    ...
    this.specifiedTimePeriod = JSON.parse(this.$route.query['记录时间段'])
  ...
  methods: {
    ...
    viewSupplierDetails(supplierInfo) {
      this.$router.push({
        ...
        query: { 名称: supplierInfo['名称'] || supplierInfo['供应商名称'] || '' } // 模式为添加产品模式
      })
    },
